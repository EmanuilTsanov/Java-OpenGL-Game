...
public class ShadowMapMasterRenderer
{
	 ...
	 * 
	 * @param entities
	 *            - the lists of entities to be rendered. Each list is associated
	 *            with the {@link TexturedModel} that all of the entities in that
	 *            list use.
	 * @param sun
	 ...
	 * 
	 * @param direction
	 *            - the light direction, and therefore the direction that the "view
	 *            cuboid" should be pointing.
	 * @param center
